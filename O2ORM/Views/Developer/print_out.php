...
<head>
    <title>
        Developer Print Out - O2ORM Database Framework
    </title>

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo assets_url(); ?>bootstrap/bootstrap.min.css">

    <!-- Bootstrap Optional theme -->
    <link rel="stylesheet" href="<?php echo assets_url(); ?>bootstrap/themes/default/default.min.css">
    <link rel="stylesheet" href="<?php echo assets_url(); ?>pretiffy/pretiffy.css">

    <!-- Font Icon CSS -->
    <link rel="stylesheet" href="<?php echo assets_url(); ?>assets/fonts/font-awesome/font-awesome.min.css">
...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <button onclick="selectCode('code')" class="btn btn-xs pull-right">Select Code</button>
        </div>
...
<!-- Include Prettify JS -->
<script type="text/javascript" src="<?php echo assets_url(); ?>pretiffy/pretiffy.js"></script>

<!-- Include Bootstrap -->
<script src="<?php echo assets_url(); ?>bootstrap/bootstrap.min.js"></script>
